  ...
  <tr>
    ...
    <td>
      <v-btn
        ...
        color="blue"
        large
        @click="$router.push(`/admin/event/${event.getId}/scan`)"
      >
        スキャンを始める
      </v-btn>
    </td>
...
import EventButton from '~/components/ui/event/EventButton.vue'

@Component({
  components: { EventButton, EventStatusCol, EventOpeningDate }
})
